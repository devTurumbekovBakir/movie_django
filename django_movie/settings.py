...
SECRET_KEY = 'django-insecure-!wsea_^vxy9yf6esgc5h0yo+@0io=s#h2@s9lsm7eb7x+0ni(%'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # pip install djangorestframework_simplejwt
    ),
